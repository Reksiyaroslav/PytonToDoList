...
from app.handlers.handlers import router as items_router
from app.auth.auth import create_jwt_token,decode_jwt_tocen,get_user_from_db
...
@app.get("/about_users")
async def about_users(user:User= Depends(decode_jwt_tocen))->dict:
